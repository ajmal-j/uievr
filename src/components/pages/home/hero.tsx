...
export default function Hero() {
  return (
    <div className='xl:min-h-[max(950px,100dvh)] lg:min-h-[max(800px,100dvh)] min-h-[max(600px,100dvh)] bg-[url("/pages/home/hero-bg-svg.svg")] bg-repeat bg-top flex flex-col gap-5 items-center justify-between h-full font-dmSans relative'>
      <HeroGradientSvg />
      <Header className='opacity-0 static' />
      <div className='flex flex-col justify-center items-center xl:text-[132px] lg:text-[120px] md:text-[100px] sm:text-[70px] text-[55px] tracking-tight z-10'>
        <h1 className='bg-gradient-to-b from-white via-white to-[#999999] bg-clip-text text-transparent text-center leading-none sm:-mb-3 -mb-1'>
          We build
        </h1>
        <h1 className='font-bold bg-gradient-to-b from-white via-white to-[#999999] bg-clip-text text-transparent text-center leading-none lg:pb-2 sm:pb-3 pb-2'>
          stunning
        </h1>
        <h1 className='bg-gradient-to-b from-white via-white to-[#999999] bg-clip-text text-transparent text-center leading-none sm:-mt-6 -mt-2'>
          apps & websites
        </h1>
      </div>
