...
export default function OurServices() {
  ...
  return (
    <div className='centered-wrapper-custom-width max-w-[1300px] flex flex-col gap-14'>
      ...
      <div className='flex flex-wrap gap-6 items-end'>
        {services.map((service, index) => (
          <div key={service} className='inline-block relative z-0 '>
            <h3
              className={`font-outfit text-[60px] tracking-tight bg-gradient-to-b from-white v to-white/70 inline-block text-center px-4 py-5 rounded-2xl bg-clip-text leading-none text-transparent transition-all duration-500 ease-in-out border-b-[3px] ${
                activeIndex === index
