      ...
      <div className="flex flex-wrap gap-6 sm:justify-start justify-center">
        {services.map((service, index) => (
          <div key={service} className="inline-block relative z-0">
            <h3
              className={`font-outfit xl:text-[60px] lg:text-[50px] md:text-[40px] sm:text-[30px] text-[26px] tracking-tight bg-gradient-to-b from-white v to-white/70 inline-block text-center md:px-4 px-3 md:py-5 py-4 rounded-2xl bg-clip-text leading-none text-transparent transition-all duration-500 ease-in-out border-b-[3px] ${
                activeIndex === index
