  ...
  return (
    ...
    >
      <div className='flex lg:flex-row flex-col xl:gap-20 lg:gap-14 md:gap-10 sm:gap-7 gap-5 items-start justify-stretch'>
        ...
        <div className='lg:flex-[2] flex sm:flex-row flex-col sm:items-center items-start justify-start 2xl:gap-12 xl:gap-10 lg:gap-8 md:gap-6 sm:gap-5 gap-4 flex-wrap'>
          <a
          ...
          <span className='inline-flex items-center gap-3 border-b border-b-[#2F2F37] pb-1'>
            <span className='text-[#F2F2F3] xl:text-[19.5px] lg:text-[16px] md:text-[14px] sm:text-[12px] text-[10px] font-medium'>
              2nd floor, matrix building, Perumbavoor 683105
            </span>
          </span>
        </div>
      </div>
