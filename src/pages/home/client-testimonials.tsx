...
const testimonials = [
  {
    ...
    name: "Presanth S Nair.",
    description:
      "Uievr transformed our vague ideas into a beautifully designed and highly functional website. The user experience was seamless, and every design element was thoughtfully crafted.",
    rating: 4.9,
  },
  {
    image: "/pages/home/icons/client-2.png",
    name: "Saranya Sreedharan.",
    description:
      "Their ability to create user-centric designs that are both visually striking and functional is unmatched. The entire team worked collaboratively with us, ensuring our vision was realized at every step of the process.",
    rating: 4.3,
  },
  {
    image: "/pages/home/icons/client-3.png",
    name: "Arjun CS.",
    description:
      "The level of professionalism, creativity, and attention to detail was top-notch. I highly recommend UIEvr to anyone looking for a high-quality, user-centered design solution.",
    rating: 4.6,
  },
  {
    image: "/pages/home/icons/client-4.png",
    name: "Vishnu P.",
    description:
      "They nailed it! Their team turned our ideas into a modern, responsive website. The attention to detail and seamless user experience truly set them apart.",
    rating: 4.8,
  },
];
